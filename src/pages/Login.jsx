  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div className="hidden md:block md:w-1/2">
        <img
          src="https://img.freepik.com/free-vector/countries-signs_23-2147502528.jpg?t=st=1745471612~exp=1745475212~hmac=6026eea50441e07a87d2b51ecb9e1d691588ba6a89a8ab4815952355c2973fe8&w=740"
          alt="World Map"
